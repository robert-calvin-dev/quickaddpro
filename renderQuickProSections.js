...
<section>
  ...
  <div class="product-wrapper">
    <div class="product-image">
      <img src="images/addpro.png" alt="Quick Add Pro">
    </div>
...
<section class="middle">
  ...
  <div class="product-wrapper">
    <div class="product-image">
      <img src="images/editpro.png" alt="Quick Edit Pro">
    </div>
    <div class="product-content">
...
<section>
  ...
  <div class="product-wrapper">
    <div class="product-image">
      <img src="images/seopro.png" alt="Quick SEO Pro">
    </div>
    <div class="product-content">
...
<section class="feature-table">
  ...
  document.addEventListener('DOMContentLoaded', function() {
    document.getElementById('apps').innerHTML = apps.appsHTML;
});
}
insertApps();
